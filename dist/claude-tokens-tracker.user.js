...
// ==/UserScript==
//
// The @require above loads the MIT gpt-tokenizer once at install time for EXACT
// o200k token counts (a one-off CDN fetch, not runtime telemetry). Delete that
// line if you prefer zero external loads — the tool falls back to a built-in
// heuristic and still works fully offline.
//
